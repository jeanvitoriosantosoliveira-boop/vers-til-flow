...
import { LayoutDashboard, KanbanSquare, BarChart3, Users, UserCog, Timer, Search, Moon, Sun, Database, Sparkles, LogOut, Wallet, Network, UserCircle2, Menu, UserPlus, Briefcase, Music2, Target, CalendarDays, Camera, Image as ImageIcon } from "lucide-react";
...
const nav: NavItem[] = [
  ...
  // Studio
  { to: "/studio/dashboard", label: "Dashboard", icon: LayoutDashboard, end: true, roles: ["studio"] },
  { to: "/studio/clients", label: "Clientes", icon: Users, roles: ["studio"] },
