-- =============================================================================
-- Rode este script no SQL Editor do Supabase (projeto de produção)
-- Cria tabelas, buckets, políticas e sincroniza vínculos time ↔ cliente ↔ membro
-- =============================================================================

-- 1) Status pausado (se ainda não existir)
DO $$ BEGIN
  IF NOT EXISTS (
...
-- 5) Colaboradores vinculados a clientes
...
-- 7) Sincronizar cliente ↔ time ↔ membros
...
-- 9) Backfill: membros já em times com clientes vinculados
INSERT INTO public.client_collaborators (client_id, user_id, source, team_id)
...
-- 11) Bucket client-logos (logo da empresa/cliente)
INSERT INTO storage.buckets (id, name, public)
...
-- 15) Recarrega cache da API REST (PostgREST) para reconhecer tabelas novas
